        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                @forelse($places as $place)
                    <div class="group bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col h-full border border-gray-100">
                        <!-- Image Container -->
                        <div class="relative h-60 overflow-hidden">
                            ...
                            <div class="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-xs font-black text-blue-600 shadow-sm uppercase tracking-widest">
                                {{ $place->country->name }}
                            </div>
                        ...
                        <div class="p-6 flex-grow flex flex-col justify-between">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                                <div class="text-xs text-gray-500 font-bold uppercase tracking-wider">
                                    🏨 {{ $place->hotels_count ?? $place->hotels->count() }} Hôtels
                                </div>
                                <a href="{{ route('places.show', $place->id) }}" class="inline-flex items-center text-sm font-black text-blue-600 hover:text-blue-800 transition-colors uppercase tracking-tight">
                                    Voir Détails &rarr;
                                </a>
                            </div>
                        </div>
